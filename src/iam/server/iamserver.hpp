...
public:
    ...
    aos::Error Init(const Config& config, aos::iam::certhandler::CertHandlerItf& certHandler,
        ...
        IAMClientItf* remoteHandler, aos::cryptoutils::CertLoader& certLoader,
...
private:
    static constexpr auto cDiscEncryptionType = "diskencryption";
    static constexpr auto cIamAPIVersion      = 4;
    static constexpr auto cMaxSubjectsCount   = 10;
    ...
    aos::iam::identhandler::IdentHandlerItf* mIdentHandler;
    aos::iam::permhandler::PermHandlerItf*   mPermHandler;
    IAMClientItf*                            mRemoteHandler;
